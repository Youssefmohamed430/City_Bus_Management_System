...
namespace City_Bus_Management_System.Migrations
{
    ...
    [Migration("20251007175959_UpdateDriverStatistics")]
    partial class UpdateDriverStatistics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core_Layer.Entities.DriverStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core_Layer.Entities.DriverStatistics", b =>
                {
                    b.HasOne("City_Bus_Management_System.DataLayer.Entities.Driver", "driver")
                        .WithOne("DriverStatistics")
                        .HasForeignKey("Core_Layer.Entities.DriverStatistics", "DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
